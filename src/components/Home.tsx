  ...
  return (
      <div>
          <Navbar className="mx-auto max-w-screen-xl px-4 py-3">
              <div className="flex flex-wrap items-center justify-between gap-y-4 text-blue-gray-900" style={{justifyContent:"space-around" }}>
                  <Typography
                      as="a"
                      href="#"
                      variant="h6"
